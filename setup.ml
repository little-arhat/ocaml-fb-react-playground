...
(* OASIS_START *)
(* DO NOT EDIT (digest: 76b30ee33891ca9fe386fc0857429c58) *)
(*
...
let setup_t =
  {
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind",
                           ["install"; "ppx_react_opts"; "src/syntax/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "ppx_react_opts"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
            {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("rm", ["-f"; "resources/js/core.js"])))
                 ]
            };
          distclean_custom =
            {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_react_opts.ml"});
               Executable
                 ({
                     cs_name = "ppx_react_generate_tags";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "ppx_react_generate_tags.ml"
                   });
               Executable
                 ({
                     cs_name = "example";
                        ...
                        [
                           (OASISExpr.EBool true,
                             [
                                "-g";
                                "-ppx";
                                "src/syntax/ppx_react_html.byte";
                                "-ppx";
                                "src/syntax/ppx_react_generate_tags.byte"
                             ])
                        ];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ô¦kPþèË\015kÃv\001\156(\139j";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
